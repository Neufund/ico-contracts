...
module.exports = deployer =>
  deployer.then(async () => {
    ...
    await deployer.deploy(Crowdsale, 1501804800, 1502356520, ether(1), ether(2), etherToken.address, NeumarkController.address, lock.address, Curve.address);
